...
it('测试##/###文章目录', async () => {
  ...
  expect(fileNode.catalogs[0].children.length).toBe(5)
  expect(fileNode.catalogs[0].children[1].title).toBe('2. 小标题一')
  expect(fileNode.catalogs[0].children[1].hash).toBe('### 2. 小标题一')
